...
export const typeWerkOpties = ['onderdelen', 'monteren', 'inpakken', 'lakwerk', 'metaalwerk', 'tekenwerk', 'plaatsen', 'overig']
...
// Facturatie (prijzen excl. btw)
export const facturatiePctOpties = [0, 30, 50, 90, 100]
